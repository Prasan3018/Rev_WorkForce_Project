    ...
    public void showMenu() {
        ...
        while (true) {
            ...
            case 3:
                ...
                boolean deact = employeeService.updateEmployeeStatus(deId, "INACTIVE");
            ...
            case 4:
                ...
                boolean act = employeeService.updateEmployeeStatus(acId, "ACTIVE");
            ...
            case 7:
                ...
                boolean changed =
                    employeeService.changeManager(eid, mid);
            ...
            case 10:
                try {
                    ...
                    System.out.println("LEAVE_ID | EMP_ID | TYPE | FROM | TO | STATUS");
            ...
            case 12:
                try {
                    ResultSet rd =
                        employeeService.getLeaveReportByDepartment();

                    System.out.println("DEPARTMENT | TOTAL_LEAVES");

                    while (rd.next()) {
                        System.out.println(
                            rd.getString("DEPARTMENT") + " | " +
            ...
            case 13:
                try {
                    ResultSet re =
                        employeeService.getLeaveReportByEmployee();
